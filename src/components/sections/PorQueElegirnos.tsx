...
const RAZONES = [
  ...
  { icon: ShieldCheck, titulo: "Productos originales", texto: "Importación y proveedores certificados." },
  { icon: MessagesSquare, titulo: "Excelente atención", texto: "Asesoría real, sin bots ni esperas." },
  ...
  { icon: BadgeCheck, titulo: "Cotización inmediata", texto: "Respondemos por WhatsApp en minutos." },
];
