...
export function Nosotros() {
  ...
  const texto = useReveal<HTMLDivElement>({ variant: "right", delay: 120 });
      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-5 lg:grid-cols-2 lg:items-center lg:px-8">
        <div ref={reveal.ref} className={reveal.className}>
          <div className="media-hover group relative">
            <div
              aria-hidden="true"
              className="absolute -inset-3 rounded-3xl border border-gold/20 transition-all duration-700 group-hover:-inset-4 group-hover:border-gold/45"
            />
            <PremiumImage
              src={localImg}
        ...
        <div ref={texto.ref} className={texto.className}>
          <SectionHeading
            align="left"
            eyebrow="Nosotros"
